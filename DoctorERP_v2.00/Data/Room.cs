...
namespace HotelApp
{
    public class Room : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Room(int id, RoomStatus status, ByanType type, HouseKeepingStatus houseKeepingStatus, bool needsRepairs, decimal price)
        {
            this.id = id;
            this.status = status;
            this.type = type;
