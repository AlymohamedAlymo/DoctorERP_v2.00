    ...
    public partial class RoomDetailsUC : UserControl
    {
        ...
        private void addGuestButton_Click(object sender, EventArgs e)
        {
            ...
            if (selectedInterval != DateTimeInterval.Empty)
            {
                ...
                booking.PricePerDay = (this.room.EndDate - this.room.StartDate).Days;
        ...
        internal void InitializeData(Byanat room, Booking booking, string comingFrom)
        {
            ...
            this.typeLabel.Image = Utils.GetImageByRoomType(ByanType.Cars);
            this.statusLabel.Text = "Status now: " + room.Name.ToString();
            this.roomIconLabel.Image = this.typeLabel.Image;
            this.roomIconLabel.LabelElement.LabelImage.Margin = new Padding(40, 0, 0, 0);
            this.statusDropDown.SelectedValue = room.Company;
            this.priorityDropDown.SelectedValue = room.StartDate;
            this.needsRepairsCheckBox.Checked = true;
            if (form != null)
            {
        ...
        private void FilterBookings(Byanat room)
        {
        ...
        {
            this.room.Description = ((RoomPriority)this.priorityDropDown.SelectedValue).ToString();
            this.room.Company = ((HouseKeepingStatus)this.statusDropDown.SelectedValue).ToString();
            ...
            if (this.booking == null && this.editGuestInfo.CurrentGuest != null)
            {
                ...
                if (bookingDuration != DateTimeInterval.Empty)
                {
                    Booking newBooking = new Booking((uint)form.Bookings.Count, editGuestInfo.CurrentGuest, this.room.Id,
                        ...
                        this.room.Id * bookingDuration.Duration.Days, BookingStatus.Reservation);
